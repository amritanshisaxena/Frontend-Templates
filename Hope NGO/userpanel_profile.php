                ...
                <div class="col-lg-8 col-xl-9">
                    <form action="#">
                        ...
                        <div class="form-group text-center">
                            <button class="btn btn-outline-dark" type="submit"><i class="fa fa-save mr-2"></i>Change Password</button>
                        </div>
                        <div class="block">
                            <!-- personal; Address-->
                            <div class="block-header">
                            ...
                            <div class="block-body">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label class="form-label col-label" for="fullname_personal;">Fullname</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="field__input" id="lastname" type="text" name="lastname_personal;" placeholder="Black" id="lastname_personal;">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="form-label col-label" for="emailaddress_personal;">Email Address</label>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label class="form-label col-label" for="Address_personal;">Street</label>
                                        <input class="field__input" type="text" name="Address_personal;" placeholder="123 Main St." id="Address_personal;">
                                    </div>
                                    <div class="form-group col-md-4">
                        ...
                        <div class="form-group text-center">
                            <a href="./userpanel_invoice.php" class="btn btn-outline-dark" type="submit"><i class="fa fa-save mr-2"></i>Save changes</a>
                        </div>
                    </form>
                </div>
